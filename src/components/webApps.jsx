import { WebAppProjects } from "./projectSlider";
...
export const WebApps = () => {
  ...
  return (
    <div className="max-w-[90rem] m-auto flex flex-col items-center justify-center py-10">
      <div
      ...
      >
        ...
        >
          {WebAppProjects.map(({ name, address }) => {
            const id = useId();
            return (
              <a
                key={id}
